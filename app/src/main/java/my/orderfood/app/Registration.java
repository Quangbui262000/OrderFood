...
public class Registration extends AppCompatActivity {
    ...
    TextInputLayout Fname,Lname,Email,Pass,cpass,mobileno,localaddress,pincode;
    Spinner Areaa,Citys;
    ...
    String fname,lname,emailid,password,confpassword,mobile,Localaddress,Pincode,Area,cityy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Areaa.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(Area.equals("DaNang")){
                    ArrayList<String> list = new ArrayList<>();
                    for (String cities : DaNang){
                        list.add(cities);
                    }
...
//
    ...
    public boolean isValid(){
        ...
        isValid = (isValidconfpassword && isValidpassword && isValidemail && isValidpincode && isValidmobilenum && isValidname && isValidlocaladd && isValidlname) ? true : false;
        return isValid;
